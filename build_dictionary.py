...
AI_OVERRIDES = {
    ...
    # 画風・描画媒体・線画・塗り表現 (AI Art Basics Guide 1.1 より)
    "traditional media": "アナログ手描き媒体 (水彩/油彩/ペーパー)",
    "faux traditional media": "アナログ風デジタル描画 (絵の具質感)",
    "mixed media": "ミックスドメディア (写真・描画・コラージュ融合)",
    "unconventional media": "非伝統的素材 (特殊画材)",
    "acrylic paint": "アクリル絵の具 (鮮やかな発色とマット感)",
    "colored pencil": "色鉛筆 (紙の質感と繊細なタッチ)",
    "graphite": "鉛筆・グラファイト (デッサン風)",
    "ink": "インク描画 (くっきりした明暗と線)",
    "marker": "コピック・マーカー (透明感と重ね塗り)",
    "millipen": "ミリペン (均一な極細線描画)",
    "nib pen": "Gペン・つけペン (漫画原稿風の抑揚線)",
    "oil painting": "油絵 (重厚なマチエールと深い色あい)",
    "pastel": "パステル画 (粉っぽく幻想的な空気感)",
    "watercolor": "水彩画 (透明感とにじみ表現)",
    "watercolor pencil": "水彩色鉛筆",
    "gouache": "ガッシュ (不透明水彩・マットな質感)",
    "digital painting": "デジタルペインティング (Webtoon・厚塗り)",
    "anime screencap": "アニメ本編キャプチャ風 (TVアニメカット)",
    "chalk": "チョークアート (黒板アート風)",
    "vector": "ベクターイラスト (ピクセル化しないクリーン作画)",
    "impasto": "インパスト (厚塗り・絵の具の盛り上がり)",
    "no lineart": "主線なし (厚塗り・ノータッチ線画)",
    "lineart": "主線あり (輪郭線強調)",
    "outline": "アウトライン強調 (くっきり輪郭)",
    "sketch": "スケッチ (下描き風の軽快な線)",
    "rough lines": "ラフ線 (力強いラフスケッチ)",
    "sketch lines": "重ね描き線 (探索的な描き込み)",
    "thick lines": "太い主線 (ポップアニメ風)",
    "thin lines": "繊細な細い主線",
    "clean lines": "クリーンな整頓された線画",
    "bold outlines": "太い外枠線 (ステッカー・ポップ風)",
    "borderless": "ボーダーレス (色のみで形を表現)",
    "crosshatching": "クロスハッチング (交差斜線による陰影)",
    "hatching shading": "ハッチング陰影 (単方向斜線)",
    "delicate lineart": "繊細で美しい極細線画",
    "flat color": "フラットカラー (アニメ塗り・ベタ塗り)",
    "cel shading": "アニメセル画塗り (くっきりした影)",
    "soft shading": "ソフトシェーディング (なめらかなグラデーション)",
    "hard shading": "ハードシェーディング (強いコントラスト影)",
    "airbrushed": "エアブラシ塗り (ふんわり質感)",
    "painterly": "ペインター塗り (筆跡を残した厚塗り)",
    "halftone": "ハーフトーン (漫画トーン・点描表現)",
    "soft cel shading": "ソフトセル塗り (柔らかい境目のアニメ塗り)",
    "anime shading": "アニメ風陰影",
    "anime coloring": "アニメカラーリング (発色の良いアニメ配色)",
    "art nouveau": "アール・ヌーヴォー (植物的曲線・装飾性)",
    "art deco": "アール・デコ (幾何学的・レトロモダン)",
    "ligne claire": "リーニュ・クレール (均一な主線とフラット塗り)",
    "nihonga": "日本画 (岩絵の具・余白の美)",
    "ukiyo-e": "浮世絵 (木版画風・平面美)",
    "game cg": "ゲームCG風 (美少女ゲーム・RPGイベントCG)",
    "official art": "公式イラスト風 (公式商品・宣伝絵風)",
    "oekaki": "お絵描き掲示板風 (レトロWebお絵かき)",
    "tegaki": "手書きブログ風 (マウス描画の味)",
